...
class XtbTrader():
    ...
    def __init__(self, client, ssid, instrument, interval, lookback, strategy, units, end, csv_results_path='/app/ch8/xbt_broker/'):
        ...
        *csv_results_path -> str, filepath where store dataframe with price data and trading results
        ...
        # NOTA 'candleFun=self.procCandle' es a donde manda el sream de datos
