...
try:
    ...
    xt = XtbTrader(instrument='GOOGL.US_9', interval='5min', lookback=1000, strategy=squeez,
                   units=0.1, session_end='2024-10-26 22:00:00', csv_results_path='/home/jovyan/src/trade', email_info=False, close_order_after_session=True)
