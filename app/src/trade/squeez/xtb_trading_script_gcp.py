...
try:
    ...
    xt = XtbTrader(instrument='NVDA.US_9', interval='5min', lookback=1000, strategy=squeez,
                   units=0.1, session_end='2024-10-30 22:00:00', csv_results_path='/home/jovyan/src/trade', email_info=True, close_order_after_session=True)
